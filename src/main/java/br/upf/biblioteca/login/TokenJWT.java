package br.upf.biblioteca.login;
...
public class TokenJWT {
	...
	private static Key gerarChave() {
		/*
		 * A string "Angelo e Cristian - Biblioteca" após a execução de SHA-256 e a execução do EncodeBase64 obteve
		 ...
		 */
		String keyString = "NTBlNGM1YTM4M2EzZjAxMTMxNTkyYzgyNmNhOGVmNDMwOGY0NzFlM2JlNDYwNWI2YWUzYjJkNjhmM2Y5MTlhZg==";
	 ...
	 *
	 * @param cdTipoUsuario, cdUsuario
	 * @return
	 */
	public static String processarTokenJWT(Long cdTipoUsuario, Long cdUsuario) {
		...
		return token.gerarToken(cdTipoUsuario, cdUsuario, dataExpiracao);
	}
	 ...
	 * @return
	 */
	public String gerarToken(Long cdTipoUsuario, Long cdUsuario, Date dataExpiracao) {
		return Jwts.builder()
				.setHeaderParam("typ", "JWT") // definindo cabeçalho
				.setSubject(cdTipoUsuario.toString()) // Subject do token
				.claim("cdUsuario", cdUsuario) // Codigo do usuario
				.setIssuer("Painel de Monitoramento de Integração") // quem é o emissor do token
	 ...
	 * @return
	 */
	public static String recuperarClaim(String token, String claim) {
		String subject = "";
