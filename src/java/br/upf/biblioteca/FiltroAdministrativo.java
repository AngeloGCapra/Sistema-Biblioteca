...
public class FiltroAdministrativo implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        Usuario usuarioLogada = (Usuario) session.getAttribute("logado-usuario");

        // Verifica se logado não existe, caso tente entrar direto na area administrativa sem passar pelo login
        if (usuarioLogada == null) {
